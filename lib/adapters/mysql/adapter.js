...
Adapter.prototype.defineCollection = function (collectionName, fields, options) {
	options = options || {};
	return new Collection(collectionName, fields, _.extend(options, { adapter: this, kit: this.kit }));
};
