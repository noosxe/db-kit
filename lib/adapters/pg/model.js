...
module.exports = (function() {
  ...
  Model.prototype.sync = function() {
    ...
    var r = queryGenerator.createTable(this.attributes, _.defaults(_.clone(this.options), { executor: executor }));
  ...
  Model.prototype.drop = function() {
    ...
    var r = queryGenerator.dropTable(this.options.tableName);
