...
/*
  Kit.prototype.begin = function() {
    return this.adapter.begin({ kit: this });
  };

  Kit.prototype.rollback = function(client, done) {
    return this.adapter.rollback(client, done);
  };

  Kit.prototype.commit = function(client, done) {
    return this.adapter.commit(client, done);
  };
